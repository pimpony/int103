...
import int102.model.MemberCard;
...
public class MemberCardTest {
    ...
    private MemberCard mcActual;

    public MemberCardTest() {
        mcActual = new MemberCard(123456789L);
    }
    @Test
    ...
    public void firstOrderLessThan25BahtAddToPurchaseOrderOnly() {
        ...
        assertEquals(0, mcActual.getNumberOfRedeem()*800);
    }
    ...
    public void firstRedeem() {
        ...
        assertEquals(1, mcActual.getNumberOfRedeem());
    ...
    public void nextRedeem() {
        ...
        assertEquals(50025, mcActual.getTotalPurchaseAmount(), 0.001);
        assertEquals(2001, mcActual.getTotalPoints());
        assertEquals(2, mcActual.getNumberOfRedeem());
